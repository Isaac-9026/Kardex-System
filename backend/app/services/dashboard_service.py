...
class DashboardService:
    ...
    async def get_metricas(self) -> DashboardMetricas:
        ...
        # Invertimos para que el gráfico empiece de la fecha más antigua a la más reciente
        ...
        # 2. TOP INCIDENCIAS: Sumar errores A, B y saldos negativos agrupados por producto
        # Usamos case() para asegurar compatibilidad universal entre bases de datos (SQLite/Postgres)
        calculo_errores = (
