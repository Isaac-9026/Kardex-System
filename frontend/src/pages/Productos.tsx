...
export default function Productos() {
  ...
  const allSelected =
    productos.length > 0 && selectedIds.size === productos.length;
  const hasSelection = selectedIds.size > 0;

  const handleEliminar = async (id: number) => {
    if (
      !confirm(
        "¿Eliminar este producto? Solo procederá si no tiene movimientos registrados.",
      )
    )
      return;
    try {
  ...
  const handleEliminarSeleccionados = async () => {
    ...
    if (
      !confirm(
        `¿Eliminar ${selectedIds.size} producto(s) seleccionado(s)? Solo procederá en los que no tengan movimientos.`,
      )
    )
      return;
          ...
          >
            ...
            >
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                ...
                >
                  <span style={{ color: "#4a7a9a", display: "flex" }}>
                    <IconSearch />
                  </span>
                  <input
                    type="text"
                    ...
                    {productos.map((p, i) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <td
                            style={{ ...td, color: "#60a5fa", fontWeight: 600 }}
                          >
                            {p.codigo}
                          </td>
                          <td style={{ ...td, color: "#8aabcc" }}>
                            {p.descripcion || "—"}
                          </td>
                          <td style={td}>
                            {esSinAsignar ? (
                          ...
                          <td style={{ ...td, textAlign: "center" }}>
                            ...
                            >
                              <button
                                ...
                                onMouseEnter={(e) => {
                                  e.currentTarget.style.background =
                                    "rgba(56,139,221,0.24)";
                                }}
                                onMouseLeave={(e) => {
                                  e.currentTarget.style.background =
                                    "rgba(56,139,221,0.12)";
                                }}
                              >
